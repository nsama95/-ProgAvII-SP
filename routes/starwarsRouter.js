...
starwarsRouter.post("/", (req, res, next) => {
    ...
    const {nombre, altura, color_pelo, color_ojos, cumpleaños,vive} = req.body;

        const nuevoPersonaje = new People({
            nombre, altura, color_pelo, color_ojos, cumpleaños,vive
        });
...
starwarsRouter.put("/:id", (req, res, next) => {
    ...
    const info = {nombre, altura, color_pelo, color_ojos, cumpleaños,vive}; 
    const infoUpdate ={};
    ...
    if (cumpleaños)
    {
        infoUpdate.cumpleaños = cumpleaños;
    }
    if (vive)
    {
        infoUpdate.vive = vive;
    }
